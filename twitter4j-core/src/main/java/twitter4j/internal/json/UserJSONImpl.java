...
public final class UserJSONImpl extends TwitterResponseImpl implements User, java.io.Serializable {
    ...
    public UserJSONImpl(String s) throws TwitterException, JSONException {
    	super();
    	
    	twitter4j.internal.org.json.JSONObject json = new twitter4j.internal.org.json.JSONObject(s);
        init(json);
    }
